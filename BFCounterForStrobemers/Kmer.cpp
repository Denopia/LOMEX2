...
Kmer::Kmer() {
  //std::cout << "K-MER MADE WITHOUT PARAMETER\n";
  //memset(bytes,0,MAX_K/4); // Allow this one in the modified version
...
Kmer::Kmer(const char *s) {
  //std::cout << "K-MER MADE WITH THE STRING PARAMETER!!!!!!!!!!!!\n";
  set_kmer(s);
}
...
Kmer Kmer::rep() const {                                                                                                              // NOW THIS IS VERY SUS!111111111111111111111111111111111
  Kmer tw = twin_MOD();
